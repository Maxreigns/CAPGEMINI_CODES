...
public class CarRepository {
    ...
    static {
        ...
        cars.add(new Car(101, "Thar", "Mahindra", Date.valueOf("2020-05-07"), "MH02AG4528"));
        cars.add(new Car(205, "Thar", "Mahindra", Date.valueOf("2018-09-07"), "MH16AG4520"));
        ...
        owners.add(new Owner(22, "Deepak", "male", List.of(cars.get(2))));
    ...
    public static List<Owner> getOwners() { return owners; }
}